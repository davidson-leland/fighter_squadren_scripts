...
public class FighterController : MonoBehaviour {
    ...
    public Fighter myFighter; // handles speed/firing guns/ turn radius/ health/ and other stats specific to individual fighters
    ...
    protected Vector3 GetLead()
    {
        ...
        Vector3 delta = target.transform.position - transform.position; //keeping bellow as a reference to actual math thingy. using own velocity causes extreme shake in lead
